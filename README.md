...
- 현재 기존 Apps Script 웹앱은 버전 **13** (`Optional post summaries and compact comment interface`)입니다. 요약·본문 선택 입력 및 목록 미리보기 처리를 반영했으며 `/exec` URL은 유지했습니다. 아래 버전 12와 초기 연결 기록의 버전 3은 과거 배포입니다.
