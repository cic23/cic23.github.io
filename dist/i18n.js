...
(() => {
  ...
  const messages = {
    ...
    '우리의 문화유산 이야기를 함께 나눠요!':'Let’s share our cultural heritage stories together!',
  ...
  function applyShell() {
    ...
    if (meta) meta.content=lang==='en' ? 'Discover Incheon’s cultural heritage and the activities of Chadwick International Culture protector (CIC), a student-led heritage club.' : '채드윅송도국제학교 청소년 국가유산지킴이 CIC의 인천 문화유산 가이드와 활동 기록입니다.';
  }
