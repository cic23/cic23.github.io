(() => {
  ...
  async function loginDialog() {
    ...
    openModal(t('<h2 id="modal-title">CIC에 오신 것을 환영합니다</h2><p>Google 계정으로 로그인하면 바로 지킴이 로그를 이용할 수 있습니다.</p><p class="muted small-text">문화유산 이야기를 남겨주세요!</p><button id="google-login" class="button secondary" disabled>Google 로그인 준비 중…</button><p class="inline-error" id="login-error" role="alert"></p>'));
